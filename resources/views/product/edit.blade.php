                      ...
                      <form action="{{ route('product.update' , $product->id) }}"  method="POST">
                        ...
                        <div class="form-group row mt-3">
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="Selling_Price" class="form-control" name="Selling_Price" required autofocus value="{{ $product->Selling_Price }}">
                          ...
                          <div class="form-group row mt-3">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="Buying_Price" class="form-control" name="Buying_Price" required autofocus value="{{ $product->Buying_Price }}">
                          ...
                          <div class="form-group row mt-3">
                            <label for="Product_Type_ID" class="col-md-4 col-form-label text-right">Product Type</label>
                            <div class="col-md-6">
                                <select class="form-select" id="Product_Type_ID" name="Product_Type_ID" aria-label="Product_Type_ID">
                                    ...
                                    <option value="{{$val->Product_Type}}" {{ ($val->Product_Type == $product->Product_Type_ID) ? 'selected' : '' }}>{{$val->Product_Type}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('id'))
