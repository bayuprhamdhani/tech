                            ...
                            <div class="col-md-6">
                                <select class="form-select" id="role" name="role" aria-label="role">
                                    ...
                                    @foreach($roles as $val)
                                        <option value="{{$val->Role_Name}}" {{ ($val->Role_Name == $user->role) ? 'selected' : '' }}>{{$val->Role_Name}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('role'))
                          ...
                          <div class="form-group row mt-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" id="Status" name="Status" aria-label="Status">
                                    ...
                                    <option value="{{$val->status}}" {{ ($val->status == $user->Status) ? 'selected' : '' }}>{{$val->status}}</option>
                                    @endforeach
                                </select>
